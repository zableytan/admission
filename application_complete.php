...
<div class="success-card">
    ...
    <p class="lead-text">Congratulations! Your application has been successfully submitted to the Davao Medical School Foundation Admission Office.</p>
    
    <div class="info-box">
        <h5><i class="bi bi-info-circle me-2"></i> What's Next?</h5>
        <p>Our admission team will review your documents. You will receive an email notification once your application status has been updated. This process usually takes 3-5 working days.</p>
    </div>
